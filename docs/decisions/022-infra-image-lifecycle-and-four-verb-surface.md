...
hermes-base   ghcr.io/mostlydev/hermes-base:v2026.3.17-claw.2
```
...
| `hermes-base` | `ghcr.io/mostlydev/hermes-base:v2026.3.17-claw.2` (dated + Clawdapus patch revision), multi-arch | pinned build-time base image resolved by `claw build` | none |
