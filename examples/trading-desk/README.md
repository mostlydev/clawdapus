...
A reference pod showing mixed managed agents (`openclaw`, `nanoclaw`, `microclaw`) running as a governed fleet — each with Discord presence and shared infrastructure context.
