...
| `Clawfile.nanobot` | Nanobot spike image with Discord startup announcement (value-trader) |
...
**Requirements:**
- Docker running
- Env-owned Discord IDs for desk-manager, momentum-trader, value-trader, and hermes, plus shared guild/channel IDs
